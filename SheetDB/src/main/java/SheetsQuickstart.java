/*
* API Documentation
* JAVA: https://developers.google.com/sheets/api/quickstart/java
* API : https://developers.google.com/sheets/api/reference/rest
* Documented by Usama Sarwar
*/
...
public class SheetsQuickstart {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        final InputStream in = SheetsQuickstart.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
    ...
    public static void main(final String... args) throws IOException, GeneralSecurityException {
        // Checking connectivity of Internet Connection
        ...
        final String spreadsheetId = "1fJPaSdL8CiK_Hz1iILm_LcGu4cX4dWJahBHzpplShZE";
        // final String range = "sheet!A1:B";
        final String range = "sheet!A:A";
